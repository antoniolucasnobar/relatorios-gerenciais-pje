...
SELECT ul.ds_nome AS "Magistrado",
        sentencas_conhecimento_pendentes_por_magistrado.pendentes_sentenca
       ...
       , -- "Ver Pendentes",
       -- T952
        sentenca_conhecimento_proferidas_por_magistrado.proferidas_sentenca
...
, -- T954
       sentencas_pendentes_execucao.pendentes_sentenca
...
,
-- T956
       incidentes_execucao_julgados_por_magistrado.julgados_execucao AS "Incidendentes de Execução Julgados"
    ,
...
-- T958
,  embargos_declaratorios_pendentes.pendentes_embargo AS "Embargos Declaratórios Pendentes",
...
-- T960
,     embargo_declaracao_julgado.quantidade_julgado AS "Embargos Declaratórios Julgados"
    ,
...
FROM sentencas_conhecimento_pendentes_por_magistrado
   INNER JOIN sentenca_conhecimento_proferidas_por_magistrado
       ON (sentenca_conhecimento_proferidas_por_magistrado.id_pessoa =
           sentencas_conhecimento_pendentes_por_magistrado.id_pessoa_magistrado)
   INNER JOIN sentencas_pendentes_execucao
   ...
   INNER JOIN tb_usuario_login ul
       ON (ul.id_usuario = sentencas_conhecimento_pendentes_por_magistrado.id_pessoa_magistrado)
ORDER BY ul.ds_nome
